...
class FcgPipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        front_cel = templates.FRONT_CEL_TMP.format(imageName=image_name)

        iso_alpha2_country_code = item['iso_alpha2_country_code']
        country_code, country_name = list(iso_alpha2_country_code.items())[0]
        ...
        back_cel = templates.BACK_CEL_TMP.format(backCelTableName=back_cel_table_name,
                                                 header=header,
